...
const discovery = new DiscoveryV1({
    ...
    authenticator: new IamAuthenticator({
        apikey: process.env.API_KEY || 'zxIfLbDWvLj6bGTg7v7wr4pJ1RGpJlfyge4T-mSLdTRq',
    }),
...
const queryConfig = {
    environmentId: process.env.ENVIRONMENT_ID || 'e6d028cf-884a-4004-9131-7bae292ed0d9',
    collectionId: process.env.COLLECTION_ID || 'd2c0c8dc-4941-4667-855c-7f28f0baaf56',
    type: "term",
    field: "answer",
    count: 1
};
